...
//        client = UploadcareClient.demoClient();
        client = new UploadcareClient("0e9e279333e12535f844","3f06f5068b47f7591dea");
        ...
        for(int i =0; i<7;i++) {
            ...
            switch (i){
                case 0:
                    ...
                    Picasso.with(this).load(url.toString()).into((ImageView) findViewById(R.id.cdn1));
                    break;
                case 1:
                    builder.grayscale();
                    URI url2 = Urls.cdn(builder);
                    Picasso.with(this).load(url2.toString()).into((ImageView) findViewById(R.id.cdn2));
                    break;
                case 2:
                    builder.flip();
                    URI url3 = Urls.cdn(builder);
                    Picasso.with(this).load(url3.toString()).into((ImageView) findViewById(R.id.cdn3));
                    break;
                case 3:
                    builder.invert();
                    URI url4 = Urls.cdn(builder);
                    Picasso.with(this).load(url4.toString()).into((ImageView) findViewById(R.id.cdn4));
                    break;
                case 4:
                    builder.mirror();
                    URI url5 = Urls.cdn(builder);
                    Picasso.with(this).load(url5.toString()).into((ImageView) findViewById(R.id.cdn5));
                    break;
                case 5:
                    builder.blur(100);
                    URI url6 = Urls.cdn(builder);
                    Picasso.with(this).load(url6.toString()).into((ImageView) findViewById(R.id.cdn6));
                    break;
                case 6:
                    builder.sharp(10);
                    URI url7 = Urls.cdn(builder);
                    Picasso.with(this).load(url7.toString()).into((ImageView) findViewById(R.id.cdn7));
                    break;
            }
        }
