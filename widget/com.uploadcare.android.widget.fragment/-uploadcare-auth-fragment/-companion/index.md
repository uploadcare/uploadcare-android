...
title: Companion -
---
//[widget](../../../index.md)/[com.uploadcare.android.widget.fragment](../../index.md)/[UploadcareAuthFragment](../index.md)/[Companion](index.md)
...
| <a name="com.uploadcare.android.widget.fragment/UploadcareAuthFragment.Companion/newInstance/#kotlin.String/PointingToDeclaration/"></a>[newInstance](new-instance.md)| <a name="com.uploadcare.android.widget.fragment/UploadcareAuthFragment.Companion/newInstance/#kotlin.String/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>fun [newInstance](new-instance.md)(loginLink: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)): [UploadcareAuthFragment](../index.md)  <br>More info  <br>Create a new instance of UploadcareAuthFragment, initialized to show the login form.  <br><br><br>
