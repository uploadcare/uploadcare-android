...
---
//[library](../../index.md)/[com.uploadcare.android.library.data](../index.md)/[UploadFromUrlData](index.md)



# UploadFromUrlData  
 [androidJvm] data class [UploadFromUrlData](index.md)(**token**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))   
...
| <a name="com.uploadcare.android.library.data/UploadFromUrlData/copy/#kotlin.String/PointingToDeclaration/"></a>[copy](copy.md)| <a name="com.uploadcare.android.library.data/UploadFromUrlData/copy/#kotlin.String/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>fun [copy](copy.md)(token: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)): [UploadFromUrlData](index.md)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.uploadcare.android.library.data/UploadFromUrlData/token/#/PointingToDeclaration/"></a>[token](token.md)| <a name="com.uploadcare.android.library.data/UploadFromUrlData/token/#/PointingToDeclaration/"></a> [androidJvm] val [token](token.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
